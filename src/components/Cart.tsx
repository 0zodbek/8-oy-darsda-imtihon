...
export default function SkillsDiagram() {
  ...
  return (
    <div className="p-6 bg-white w-[1440px] px-[90px] mx-auto">
      <h2 className="text-2xl font-bold mb-6 border-s-8 border-[#0956AF] text-black">Шахсий ва касбий хусусиятлар</h2>
      ...
      <div className="mt-8">
        <h2 className="text-3xl border-s-8 border-[#0956AF] font-bold mb-4 text-black">Психологик диагностика</h2>
